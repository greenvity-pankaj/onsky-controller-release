...
if [ ! -f opt/greenvity/llp/llp_Dev_Config.txt ]; then
	...
	echo "6,slight_sw_1_name,8,4,3,1,0xA1" >> llp_Dev_Config.txt	#slight_sw_1_name - Dont Send & store/Update Device Name to flash.
	echo "6,slight_sw_2_name,9,4,3,1,0xA1" >> llp_Dev_Config.txt	#slight_sw_2_name - Dont Send & store/Update Device Name to flash.
	echo "6,slight_name_1,10,4,3,1,0xA1" >> llp_Dev_Config.txt		#slight_name_1 - Dont Send & store/Update Device Name to flash.
	echo "6,slight_name_2,11,4,3,1,0xA1" >> llp_Dev_Config.txt		#slight_name_2 - Dont Send & store/Update Device Name to flash.
	echo "6,slight_name_3,12,4,3,1,0xA1" >> llp_Dev_Config.txt		#slight_name_3 - Dont Send & store/Update Device Name to flash.
	echo "6,slight_name_4,13,4,3,1,0xA1" >> llp_Dev_Config.txt		#slight_name_4 - Dont Send & store/Update Device Name to flash.
	...
	echo "9,tps_rev1,2,1,3,0,0xA1" >> llp_Dev_Config.txt		#tps_rev1 - Dont Send this TLV & BITMAP = 0	
	echo "9,tps_rev2,3,1,3,0,0xA1" >> llp_Dev_Config.txt		#tps_rev2 - Dont Send this TLV & BITMAP = 0	
	echo "9,tps_rev3,4,1,3,0,0xA1" >> llp_Dev_Config.txt	 	#tps_rev3 - Dont Send this TLV & BITMAP = 0	
	echo "9,tps_rev4,5,1,3,0,0xA1" >> llp_Dev_Config.txt		#tps_rev4 - Dont Send this TLV & BITMAP = 0	
